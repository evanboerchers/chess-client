...
export default class PlayerCustomModal extends Phaser.GameObjects.Container {
    ...
    constructor(scene: Phaser.Scene, x: number, y: number, properties: PlayerCustomModalProperties = {}) {
        ...
        this.contentContainer = this.scene.add.container(0, -this.properties.height/2)
    ...
    private createBackground(): void {
        ...
        this.background.fillRoundedRect(-this.properties.width/2, -this.properties.height/2, this.properties.width, this.properties.height, this.properties.cornerRadius);
