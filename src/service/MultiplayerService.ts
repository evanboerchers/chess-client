...
export class MultiplayerService {
    ...
    private readonly eventHandlers: Map<keyof ServerToClientEvents, Function[]> = new Map();
    ...
    private registerServerEvents() {
        ...
        this.socket.on('gameStarted', (state: GameState) => this.emit('gameStarted', state));
        this.socket.on('makeMove', () => this.emit('makeMove'));
        this.socket.on('waiting', () => this.emit('waiting'));
        this.socket.on('moveMade', (move: Move, state: GameState) => this.emit('moveMade', move, state));
        this.socket.on('drawOffered', () => this.emit('drawOffered'));
        this.socket.on('gameOver', (result: GameOutcome) => this.emit('gameOver', result));
